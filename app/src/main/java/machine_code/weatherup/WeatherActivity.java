...
import machine_code.weatherup.data.Condition;
import machine_code.weatherup.data.LocationResult;
import machine_code.weatherup.data.Units;
import machine_code.weatherup.fragments.WeatherConditionFragment;
import machine_code.weatherup.listener.GeocodingServiceListener;
import machine_code.weatherup.listener.WeatherServiceListener;
import machine_code.weatherup.service.GoogleMapsGeocodingService;
import machine_code.weatherup.service.WeatherCacheService;
import machine_code.weatherup.service.YahooWeatherService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(WeatherActivity.this,SatelliteActivity.class));
            }
        });
    }
